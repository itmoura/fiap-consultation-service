package com.fiap.itmoura.consultation_service.user.application.interfaces;
...
public interface UserControllerInterface {
    ...
    List<UserDTO> findByTypeUserRole(@Parameter(description = "ID do tipo de usuário") @PathVariable TypeUserEnum typeUserRole);
    ...
    Long countUsersByType(@Parameter(description = "ID do tipo de usuário") @PathVariable TypeUserEnum typeUserRole);
